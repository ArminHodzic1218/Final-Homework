    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Student> students = new List<Student>
                {
                  new Student("Adnan","Hodzic","Tuzla","adnan@gmail.com"),
                  new Student("Armin","Hodzic","Tuzla","anhc1218@gmail.com"),
                  new Student("Fahrudin","Hodzic","Sarajevo","fahrudin@gmail.com"),
                  new Student("Dzenan" , "Stlic", "Sarajevo ","dzenan@gmail.com"),
                  new Student("Ervin ", "Begic","Tuzla", "ervin@gmail.com"),
